...
public class TrieTester {
     ...
     * For example
     *
     * abacus 12 abasement 23 abase 43 abroad 32 aloud 23 all 56 allowed 44 aba
     * abase abasement abroad aloud broad
     *
     * using get aba: null abase: TrieNode; isTerminal=true, data=43,
     * #children=1 abasement: TrieNode; isTerminal=true, data=23, #children=0
     * abroad: TrieNode; isTerminal=true, data=32, #children=0 aloud: TrieNode;
     * isTerminal=true, data=23, #children=0 broad: null
     *
     * using getNode aba: TrieNode; isTerminal=false, data=null, #children=2
     * abase: TrieNode; isTerminal=true, data=43, #children=1 abasement:
     * TrieNode; isTerminal=true, data=23, #children=0 abroad: TrieNode;
     * isTerminal=true, data=32, #children=0 aloud: TrieNode; isTerminal=true,
     * data=23, #children=0 broad: null
     */
    ...
    /**
     *
     * Test out the Trie implementation for prefix search. Expect a list on
     * standard in of the words and the data to be inserted and then a second
     * line that searches for prefixes in the Trie.
     *
     * For example abacus 12 abasement 34 abase 56 abroad 67 aloud 3 all 34
     * allowed 43 allow 32 allowance 11 abroad 12 aba all br
     *
     * aba: [abacus, abase, abasement] all: [all, allow, allowance, allowed]
     *
     */
     ...
     * Trie. For example:
     *
     * <code>4 word-freq.expanded.txt anomaly aba hoodie</code>
     *
     * @param in
     */
    ...
    /**
     * Test out the getMostFrequentWordWithPrefix method. Expects a file name
     * that is the dictionary and then a some of words to search for in the
     * newly created Trie. For example
     *
     * <cdoe>5 word-freq.expanded.txt aba the bbb</code>
     *
     * @param in
     */
